...
tiempo = int(input("Ingrese el tiempo de carga (segundos): "))

print(f"\nIniciando subida de {tamaño} MB...\n")

# Configuración de la simulación
pasos = 20  # número de actualizaciones (5% cada una)
intervalo = tiempo / pasos  # tiempo de espera entre cada actualización

# Bucle de simulación
for i in range(1, pasos + 1):
    porcentaje = int((i / pasos) * 100)
    barras_llenas = "#" * (i)
    barras_vacias = "-" * (pasos - i)
    barra = f"[{barras_llenas}{barras_vacias}] {porcentaje}%"
